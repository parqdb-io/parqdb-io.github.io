...
- [`metadata.md`](/docs/0.2/spec/metadata): index metadata format and snapshots.
- [`catalog.md`](/docs/0.2/spec/catalog): catalog state and atomic metadata commits.
- [`static-package.md`](/docs/0.2/spec/publication-manifest): immutable HTTP-queryable IVF-LVQ
  snapshots.

Relation profiles:

- [`storage/parquet.md`](/docs/0.2/spec/storage/parquet)
- [`storage/iceberg.md`](/docs/0.2/spec/storage/iceberg)

IVF:

- [`ivf/index-schema.md`](/docs/0.2/spec/ivf/index-schema)
- [`ivf/query.md`](/docs/0.2/spec/ivf/query)

Non-normative test vectors:

- [`fixtures/v1/`](https://github.com/parqdb-io/parqdb/tree/v0.2.0rc3/spec/fixtures/v1): valid and invalid metadata, Parquet tables,
