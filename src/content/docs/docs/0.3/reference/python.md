...
See the [server guide](/docs/0.3/guides/server) for source authorization, storage,
...
created. See [configuration](/docs/0.3/reference/configuration) for the complete set of keys.
